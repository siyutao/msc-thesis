...
difficulty in deciding between core and non-core (complements and adjuncts) dependents
\subsection{Word order information}

\subsection{Morphological case marking}
Qualified as morphological case marking. due to specific 
...
Recall the bimodal distribution of transitive verbs, verbs that are highly transitive or highly intransitive will have high entropy wrt object, carrier more information. Verb specific feature -> higher entropy.
