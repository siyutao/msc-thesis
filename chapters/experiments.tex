...
Most distributions are bimodal with peak at both ends, which supports overall cross-lingual validity of a binary conception of transitivity. But exceptions abound as well, among others Indonesian (unimodal with peak in the middle), Catalan, Galician, Spanish (unimodal with peak on right). And even between the bimodal distributions, we note that they are rarely symmetric, with differing levels of skew towards either end. 
