...
\title{Towards a quantitative approach to verbal valency}
\subtitle{A quantitative typological study based on Universal Dependencies}
\author{Siyu Tao}
\date{\today}
\publishers{
    \begin{tabular}{rl}
...
\include{chapters/transitivity}
\include{chapters/entropy}
